...
public class ObjectFactory {
    ...
    private final static QName _Compte_QNAME = new QName("http://service.ACT5_1/", "compte");
    private final static QName _Conversion_QNAME = new QName("http://service.ACT5_1/", "conversion");
    private final static QName _ConversionResponse_QNAME = new QName("http://service.ACT5_1/", "conversionResponse");
    private final static QName _GetComptes_QNAME = new QName("http://service.ACT5_1/", "getComptes");
    private final static QName _GetComptesResponse_QNAME = new QName("http://service.ACT5_1/", "getComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://service.ACT5_1/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://service.ACT5_1/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://service.ACT5_1/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://service.ACT5_1/", name = "getComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://service.ACT5_1/", name = "getComptesResponse")
